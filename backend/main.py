...
def analyze_receipt(
    ...
    try:
        ...
        prompt = """
            ...
            選択肢:
            ["食費", "日用品", "交際費", "交通費", "エンタメ", "医療・健康", "衣服・美容", "水道・光熱", "通信・家賃", "自己投資・教育", "貯蓄・投資", "その他"]
            ...
            - 日用品: 生活消耗品、洗剤、シャンプー、ティッシュ、トイレットペーパー、ゴミ袋、文房具、食器、その他生活雑貨（食品・衣類・化粧品・医薬品以外の日常的な必需品）。
            - 交際費: プレゼント、贈答品、お土産、冠婚葬祭、交際を目的とした外食（飲み会・会食・接待など）の費用。
            - 交通費: 電車、バス、タクシー、駐車場、ガソリン、高速料金、定期券など。
            - エンタメ: 映画、ゲーム、イベント、レジャー、サブスク、おもちゃ、ホビー、趣味用の書籍・雑誌など。
            - 医療・健康: 病院、クリニック診療費、処方薬、市販医薬品、サプリメント、健康診断、コンタクトレンズ、スポーツジムなど。
            - 衣服・美容: 洋服、靴、下着、美容室・理容室、化粧品、メイク用品、エステなど。
            - 水道・光熱: 電気料金、ガス料金、水道料金など。
            - 通信・家賃: 家賃、インターネット回線、携帯電話料金、レンタルサーバー代など。
            - 自己投資・教育: 教科書、学習用参考書、ビジネス書、資格試験受験料、塾、習い事、セミナー受講料など。
            - 貯蓄・投資: 投資信託、株式購入、積立NISA、保険料（生命保険、損害保険など）の支払など。
            ...
            【出力JSONスキーマ】
            {
              ...
              "category_name": "食費 | 日用品 | 交際費 | 交通費 | エンタメ | 医療・健康 | 衣服・美容 | 水道・光熱 | 通信・家賃 | 自己投資・教育 | 貯蓄・投資 | その他",
              "items": [
                {
                  "name": "品目名",
                  "price": 数値 または null,
